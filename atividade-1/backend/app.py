...
from utils import build_mempool_summary, ok, fail
...
def api_node():
    ...
    try:
        ...
        return fail(
            "Falha ao consultar estado do node via RPC.",
            details=str(e),
            code=502,
        )
...
def api_blocks_recent():
    ...
    try:
        ...
        return fail(
            "Falha ao consultar blocos recentes via RPC.",
            details=str(e),
            code=502,
        )
...
def api_blockchain_lag():
    ...
    try:
        ...
        return fail(
            "Falha ao consultar lag da blockchain.", details=str(e), code=502
        )
